...
<div class="main-container">
    <div class="auth-card">
        <div class="auth-header">
            {{-- Título alterado para a página de nova senha --}}
            <h1 class="auth-title" style="font-size: 2rem;">Criar Nova Senha</h1>
        </div>
        ...
        <div class="auth-body">
            <form method="POST" action="{{ route('password.update') }}">
                ...
                {{-- Token de redefinição de senha (oculto) --}}
                ...
                <div class="form-group">
                    ...
                    <input id="email"
                           ...
                           name="email"
                           value="{{ $email ?? old('email') }}" {{-- $email é passado pela rota --}}
                           required
                           autocomplete="email"
                           placeholder="Digite seu email"
                           readonly {{-- Geralmente o email não é editável aqui --}}
                           style="background-color: rgba(255,255,255,0.1); cursor: not-allowed;" {{-- Estilo para readonly --}}
                           >
                    @error('email')
